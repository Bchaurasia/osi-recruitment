...
public class RegisterUserController {
	...
	public void verifyUser(@RequestParam(value = "versionId", required = false) String versionId,HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		+servletContext.getContextPath()+"/login.html";

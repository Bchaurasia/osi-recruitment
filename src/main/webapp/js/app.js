var app = angular.module('erApp', ['angular-flexslider','ngTagsInput','ngGrid','ngRoute','angularFileUpload','blockUI', 'ui.utils.masks', 'ui.router','xeditable','ui.bootstrap', 'ui.bootstrap.datetimepicker', 'ui.select','ngSanitize','ngNotify','components','ngAnimate','kendo.directives','ngIdle','angularMoment']);

angular.module('erApp')
		   .service('positionSearchService',['$http','$filter','$rootScope','appConstants','$q', '$timeout',	positionService]);
...
function positionService($http,$filter,$rootScope,$timeout,$log,appConstants) {
	...
	function searchPosition(searchVal){
		return $http.get('resources/positionSearch?client='+searchVal)
